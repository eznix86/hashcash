...
"""
    ...
    Example:
        >>> import hashlib
        >>> hashlib.sha256('denmark2890CF'.encode()).hexdigest() '000000cf89643370c24e413ec0886ab92bd7f6e8'
...
def verify_token(s, token):
    ...
    return trailing_zeros(hash(hashlib.sha256(s.encode()).digest() + token.encode()))
